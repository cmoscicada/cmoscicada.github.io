var store = [{
        ...
        "excerpt":"도커를 배우고, 설정해 나가면서 도움을 받았던 페이지들을 정리해 보려고 한다. Docker with GUI Movitation: Inkscape 우분투로 환경을 바꾸면서 Visio 툴을 대체할 것이 필요했다. 검색을 하다가 최종적으로 inkscape 툴로 정착하기로 하였다. Visio로는 주로 아래와 같은 작업들을 했었다. 논문 Figure 회로 스케메틱 회로 시스템 블락 다이어그램 그래프 / 표 작성 검색 끝에...","categories": ["Blog"],
        "tags": ["Blog"],
        "url": "http://0.0.0.0:4000/blog/2nd-post/",
        "teaser":"http://0.0.0.0:4000/"},{
        "title": "github.io 블로그 시작하기",
        "excerpt":"GitHub Blog 서비스인 github.io 블로그 시작하기로 했다. GitHub Blog 서비스의 이름은 Pages이다. Pages가 다른 블로그 플랫폼 보다 편한 것 같아서 마음에 든다. 다른 사람들도 같이 많이 사용했으면 좋겠다는 생각이 든다. YFM에서 정의한 제목을 이중 괄호 구문으로 본문에 추가할 수 있다. 이 글의 제목은 github.io 블로그 시작하기이고 마지막으로 수정된 시간은 2020-01-22이다....","categories": ["Blog"],
        "tags": ["Blog"],
